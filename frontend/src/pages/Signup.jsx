          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-3 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-12"
                  placeholder="********"
                  required
                />
                <button
